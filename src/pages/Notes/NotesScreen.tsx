...
const CATEGORY_TABS = [
  ...
  { id: 'Conversation', label: 'Conversation', icon: 'chatbubbles', color: '#00897B' },
...
export const NotesScreen: React.FC = () => {
  ...
  const handleNotePress = (note: NoteItem) => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Download PDF', onPress: () => Alert.alert('Downloading', `${note.title}.pdf is downloading for offline access.`) },
        { text: 'Read Now', onPress: () => Alert.alert('Opening Reader', `Loading ${note.title}...`) },
      ]
    );
  };
  ...
  const handleDownloadAll = () => {
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'Download All', onPress: () => Alert.alert('Downloading All', 'All study materials will be saved offline.') },
      ]
    );
  };
      ...
      >
        ...
        <View style={styles.heroBanner}>
          <View style={styles.heroLeftContent}>
            ...
            <Text style={styles.heroTags}>Notes • PDFs • Grammar • Practice</Text>
          </View>
          ...
          <View style={styles.heroArtBox}>
            <Svg width="120" height="110" viewBox="0 0 130 120">
              {/* Stack of books */}
              <Rect x="20" y="70" width="80" height="12" rx="2" fill="#00C853" />
              <Rect x="15" y="82" width="90" height="12" rx="2" fill="#FF3B30" />
              <Rect x="10" y="94" width="100" height="12" rx="2" fill="#FFB300" />
              {/* Notepad with quote */}
              <Rect x="55" y="16" width="65" height="70" rx="4" fill="#FFFFFF" stroke="#CBD5E1" strokeWidth="1" />
              <Rect x="55" y="16" width="65" height="10" rx="2" fill="#0084FF" />
              <Path d="M 62 38 L 110 38 M 62 48 L 105 48 M 62 58 L 95 58" stroke="#94A3B8" strokeWidth="1.5" />
              <Circle cx="108" cy="72" r="6" fill="#FEF9E7" />
              <Path d="M 105 72 Q 108 76 111 72" stroke="#FF9800" strokeWidth="1.5" fill="none" />
              {/* Pencil Cup */}
              <Rect x="98" y="55" width="18" height="24" rx="3" fill="#0084FF" />
              <Path d="M 103 40 L 103 55 M 109 36 L 109 55" stroke="#FFC107" strokeWidth="2.5" />
            </Svg>
          </View>
        </View>
        ...
        <View style={styles.sectionHeader}>
          <View style={styles.sectionTitleLeft}>
            ...
            <Text style={styles.sectionTitleText}>All Notes ({filteredNotes.length})</Text>
          </View>
          <TouchableOpacity
